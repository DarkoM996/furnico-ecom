...
const Testimonials = () => {
  return (
    <section className="max-w-screen-3xl mx-auto w-full h-screen relative px-6 py-6 lg:px-28 lg:py-24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 w-full h-fit">
        {/* Card 1*/}
        <div className="flex flex-col justify-center items-start gap-2 px-6 py-4 bg-primary_lighterShade-200 rounded-3xl">
